    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-20 text-center">
        ...
        >
          ...
          <span className="font-semibold text-ink-800">scalable</span> web applications with
        ...
        <div className="anim-slide-up delay-600 mx-auto mb-10 max-w-lg" style={{ opacity: 0 }}>
          <CodeBlock filename="developer.profile.ts">
            <div>
              ...
              <CodeToken type="variable">developer</CodeToken>{' '}
        ...
        <div
          className="anim-fade-up mx-auto mt-20 grid max-w-md grid-cols-3 gap-8 delay-1000"
          style={{ opacity: 0 }}
        >
