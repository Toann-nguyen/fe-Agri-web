  ...
  return (
    <section id='stack' className='relative bg-white py-24 md:py-32'>
      ...
      <div className='relative mx-auto max-w-7xl px-6'>
        ...
        <div className='bento-grid grid grid-cols-4 grid-rows-3 gap-4' style={{ minHeight: '520px' }}>
                  ...
                  {item.size === 'large' ? (
                    ...
                    <>
                      <div className='flex size-14 shrink-0 items-center justify-center rounded-xl bg-black shadow-lg shadow-black/10 transition-all duration-500 group-hover:scale-110'>
                        <span className={item.iconColor === 'cyan' ? 'text-white' : 'text-cyan-400'}>{item.icon}</span>
                      </div>
                      <div>
                    ...
                    <>
                      ...
                      <span className='mt-1 font-mono text-[10px] text-ink-400'>{item.description}</span>
                    </>
                  )}
                </GlassCard>
              </Card3D>
