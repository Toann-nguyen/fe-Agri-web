...
const expertiseItems = [
  {
    ...
    code: (
      <div>
        ...
        <br />
        <CodeToken type="keyword">interface</CodeToken>{' '}
        <CodeToken type="type">UserRepository</CodeToken>{' '}
  ...
  },
  {
    ...
    description:
      'Resolving N+1 queries, implementing Redis caching, optimizing MySQL for sub-50ms responses.',
    stats: [
  ...
  },
  {
    ...
    description:
      'Crafting intuitive React.js/Next.js dashboards with responsive design and micro-interactions.',
    chart: true,
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="reveal active mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-ink-400">
            Task-oriented expertise across the full stack, from database queries to pixel-perfect
            interfaces.
          </p>
        </div>
